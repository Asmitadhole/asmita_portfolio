...
const ProjectCard: React.FC<ProjectProps> = ({ project, index }) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-xl shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300 bg-white dark:bg-slate-600 text-gray-900 dark:text-white"
    >
      {/* Image Section */}
      ...
      >
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {project.tech.map((tech, idx) => (
            <motion.span
              key={idx}
              className="px-3 py-1 bg-slate-200 dark:bg-purple text-purple dark:text-black rounded-full text-sm font-medium"
